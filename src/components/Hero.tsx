  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-5xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Simplifiez Votre Cabinet avec une Gestion Dentaire
        <span className="relative whitespace-nowrap text-[#776AF6]">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-[#776AF6]/70"
          ...
          <span className="relative">Tout-en-Un</span>
        </span>
      </h1>
